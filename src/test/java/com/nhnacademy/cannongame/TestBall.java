...
import com.nhnacademy.cannongame.ball.AbstractBall;
import com.nhnacademy.cannongame.ball.SimpleMovableBall;
...
class TestBall extends AbstractBall {
    ...
    public TestBall(Point center, double radius) {
        super(new Point(center.getX(), center.getY()), radius);
    }
...
class AbstractBallTest {
    ...
    public void testAbstractBallCreation() {
        ...
        Vector2D velocity = (Vector2D) movableBall.getVelocity();
        assertEquals(0.0, velocity.get(0), 0.001, "초기 X 속도가 0이 아닙니다");
